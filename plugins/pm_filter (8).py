...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, SUPPORT_CHAT_ID, CUSTOM_FILE_CAPTION, MSG_ALRT, PICS, AUTH_GROUPS, P_TTI_SHOW_OFF, UPDT_CHNL, MY_CHNL, MY_GRP, NOR_IMG, LOG_CHANNEL, SPELL_IMG, MAX_B_TN, IMDB, \
...
async def next_page(bot, query):
    ...
    try:
        if settings['auto_delete']:
            ...
            btn.insert(0, 
                [
                    ɪɴʟɪɴᴇᴋᴇʏʙᴏᴀʀᴅʙᴜᴛᴛᴏɴ(f'ɪɴғᴏ', 'reqinfo'),
                    ɪɴʟɪɴᴇᴋᴇʏʙᴏᴀʀᴅʙᴜᴛᴛᴏɴ(f'ᴍᴏᴠɪᴇs', 'minfo'),
                    ɪɴʟɪɴᴇᴋᴇʏʙᴏᴀʀᴅʙᴜᴛᴛᴏɴ(f'sᴇʀɪᴇs', 'sinfo')
                ]
            )
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>ᴛʜᴇ ʀᴇsᴜʟᴛs ғᴏʀ ☞ ‛{search}’\n ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ ☞  {message.from_user.mention}\n ᴛʜɪs ᴍᴇssᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ 𝟷𝟶 ᴍɪɴᴜᴛᴇs.</b>"
